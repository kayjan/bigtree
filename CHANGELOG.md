...
## [Unreleased]
### Added:
- Dos: Default doctest in github workflows and `pytest` commands.
### Fixed:
...
### Changes:
- Tree: Method `yield` renamed to `yield_tree` so it does not clash with Python keyword.
...
- Docs: Update variable name for common module.
- Common: `assemble_attributes` function to add defaults.
