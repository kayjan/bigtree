...
class TestPreOrderIter:
    ...
    def test_preorder_iter(tree_node):
        ...
        actual = [_node.node_name for _node in iterators.preorder_iter(tree_node)]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"

    @staticmethod
    def test_preorder_iter2(tree_node2):
        expected = ["a", "b", "d", "g", "e", "h", "i", "c", "f"]
        actual = [_node.node_name for _node in iterators.preorder_iter(tree_node2)]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"
    ...
    def test_preorder_iter_filter_condition(tree_node):
        ...
        actual = [
            _node.node_name
            for _node in iterators.preorder_iter(
                tree_node,
    ...
    def test_preorder_iter_max_depth(tree_node):
        ...
        actual = [
            _node.node_name for _node in iterators.preorder_iter(tree_node, max_depth=3)
        ]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"
...
class TestPostOrderIter:
    ...
    def test_postorder_iter(tree_node):
        ...
        actual = [_node.node_name for _node in iterators.postorder_iter(tree_node)]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"

    @staticmethod
    def test_postorder_iter2(tree_node2):
        expected = ["g", "d", "h", "i", "e", "b", "f", "c", "a"]
        actual = [_node.node_name for _node in iterators.postorder_iter(tree_node2)]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"
    ...
    def test_postorder_iter_filter_condition(tree_node):
        ...
        actual = [
            _node.node_name
            for _node in iterators.postorder_iter(
                tree_node,
                filter_condition=lambda x: x.node_name in ["a", "d", "e", "f", "g"],
            )
        ]
    ...
    def test_postorder_iter_max_depth(tree_node):
        ...
        actual = [
            _node.node_name
            for _node in iterators.postorder_iter(tree_node, max_depth=3)
        ]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"
...
class TestLevelOrderIter:
    ...
    def test_levelorder_iter(tree_node):
        ...
        actual = [_node.node_name for _node in iterators.levelorder_iter(tree_node)]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"

    @staticmethod
    def test_levelorder_iter2(tree_node2):
        expected = ["a", "b", "c", "d", "e", "f", "g", "h", "i"]
        actual = [_node.node_name for _node in iterators.levelorder_iter(tree_node2)]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"
    ...
    def test_levelorder_iter_filter_condition(tree_node):
        ...
        actual = [
            _node.node_name
            for _node in iterators.levelorder_iter(
                tree_node,
                filter_condition=lambda x: x.node_name in ["a", "d", "e", "f", "g"],
            )
        ]
    ...
    def test_levelorder_iter_max_depth(tree_node):
        ...
        actual = [
            _node.node_name
            for _node in iterators.levelorder_iter(tree_node, max_depth=3)
        ]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"
...
class TestZigZagIter:
    ...
    def test_zigzag_iter(tree_node):
        ...
        actual = [_node.node_name for _node in iterators.zigzag_iter(tree_node)]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"

    @staticmethod
    def test_zigzag_iter2(tree_node2):
        expected = ["a", "c", "b", "d", "e", "f", "i", "h", "g"]
        actual = [_node.node_name for _node in iterators.zigzag_iter(tree_node2)]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"
    ...
    def test_zigzag_iter_filter_condition(tree_node):
        ...
        actual = [
            _node.node_name
            for _node in iterators.zigzag_iter(
                tree_node,
                filter_condition=lambda x: x.node_name in ["a", "d", "e", "f", "g"],
            )
        ]
    ...
    def test_zigzag_iter_max_depth(tree_node):
        ...
        actual = [
            _node.node_name for _node in iterators.zigzag_iter(tree_node, max_depth=3)
        ]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"
...
class TestBinaryTreeIterator:
    ...
    def test_preorder_iter_max_depth(binarytree_node):
        ...
        actual = [
            _node.node_name
            for _node in iterators.preorder_iter(binarytree_node, max_depth=3)
        ]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"
    ...
    def test_postorder_iter(binarytree_node):
        ...
        actual = [
            _node.node_name for _node in iterators.postorder_iter(binarytree_node)
        ]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"
    ...
    def test_levelorder_iter(binarytree_node):
        ...
        actual = [
            _node.node_name for _node in iterators.levelorder_iter(binarytree_node)
        ]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"
    ...
    def test_levelorder_iter_max_depth(binarytree_node):
        ...
        actual = [
            _node.node_name
            for _node in iterators.levelorder_iter(binarytree_node, max_depth=3)
        ]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"
    ...
    def test_inorder_iter(binarytree_node):
        ...
        actual = [_node.node_name for _node in iterators.inorder_iter(binarytree_node)]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"
    ...
    def test_inorder_iter_filter_condition(binarytree_node):
        ...
        actual = [
            _node.node_name
            for _node in iterators.inorder_iter(
                binarytree_node,
                filter_condition=lambda x: x.node_name in ["1", "4", "3", "6", "7"],
            )
        ]
    ...
    def test_inorder_iter_max_depth(binarytree_node):
        ...
        actual = [
            _node.node_name
            for _node in iterators.inorder_iter(binarytree_node, max_depth=3)
        ]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"
    ...
    def test_zigzag_iter(binarytree_node):
        ...
        actual = [_node.node_name for _node in iterators.zigzag_iter(binarytree_node)]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"
    ...
    def test_zigzag_iter_max_depth(binarytree_node):
        ...
        actual = [
            _node.node_name
            for _node in iterators.zigzag_iter(binarytree_node, max_depth=3)
        ]
        assert actual == expected, f"Expected\n{expected}\nReceived\n{actual}"
