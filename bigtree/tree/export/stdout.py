...
def tree_to_html(
    ...
    def _get_colour_and_attr(colour_param: str, default_param: str) -> tuple[str, str]:
    ...
    node_colour, node_colour_attr = _get_colour_and_attr(
        node_colour, DEFAULT_NODE_COLOUR
    )
    border_colour, border_colour_attr = _get_colour_and_attr(
        border_colour, DEFAULT_BORDER_COLOUR
    )
    font_colour, font_colour_attr = _get_colour_and_attr(
