function _typeof(t) {
    ...
    function() {
                    ...
                    return t().wrap((function(t) {
                        for (;;) switch (t.prev = t.next) {
                            ...
                            case 5:
                                ...
                                o = "".concat(window.location.origin, "/").concat(window.location.pathname.split("/")[1], "/playground/"), a = n ? window.colorNotebook.notebookWheels : window.colorNotebook.playgroundWheels, s = [], n ? y = !0 : v = !0, l = r(a);
                                try {
            ...
            I = function() {
                var e = n(t().mark((function e(o, r) {
                    ...
                    return t().wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if (c = {}, !window.location.pathname.endsWith("/playground/")) {
                                    e.next = 32;
                                    break
                                }
                                if (i = r || new URLSearchParams(window.location.search), a = "Loading Pyodide...", s = "", u = i.has("source") ? i.get("source") : i.get("notebook"), d = document.querySelector("article"), null === u || !u.trim()) {
                                    e.next = 16;
                                    break
                                }
        ...
        document.addEventListener("click", (function(t) {
            ...
            if ("A" === n.tagName && I && n.getAttribute("href") && n.host === window.location.host && window.location.pathname === "/".concat(e, "/playground/") && window.location.pathname === n.pathname && window.location.search !== n.search) {
                t.preventDefault();
            ...
            window.location.pathname === "/".concat(t, "/playground/") && (decodeURIComponent(new URLSearchParams(window.location.search).toString()) !== p && I(!1))
